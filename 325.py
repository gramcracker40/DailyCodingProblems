...
class MeasurementConverter:
    ...
    def convert(self, unit):
        ...
        '''
        try:
            factor = MeasurementConverter.ratios[f"{self.unit}{unit}"]
    ...
    def compare(self):
        ...
        '''
        other_units = {x for x in MeasurementConverter.units 
                       if x != self.unit}
...
if __name__ =="__main__":
    test = MeasurementConverter(12, unit="chain", accuracy=7)
